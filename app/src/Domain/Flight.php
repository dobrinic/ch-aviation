...
class Flight
{
    ...
    {
        return $this->actualStart->getTimestamp() - $this->actualEnd->getTimestamp();
    }

    public function wasLandingMissed(): bool
    {
        $timeDifference = $this->actualEnd->getTimestamp() - $this->scheduledEnd->getTimestamp();
